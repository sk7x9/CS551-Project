...
public class RegisterScreeen extends Activity implements OnInitListener {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
						...
						|| regmail.getText().toString().equals(""))
				{
					...
					tts.speak("Successfully registered", TextToSpeech.QUEUE_FLUSH, null);
					
					editor.putString("phonenumber", regnum.getText().toString());
