...
public class JobsList extends Activity implements OnClickListener,OnInitListener {
	...
	public class ItemListArrayAdapter extends ArrayAdapter<ParserObject> implements OnInitListener {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			details.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					pref=JobsList.this.getSharedPreferences("edu.umkc.lee", 0);	
					String num=pref.getString("phonenumber", "8168125371");
					SmsManager sms = SmsManager.getDefault();
					String text="you viewed a position in "+values.get(position).getName()+"\n by JobAmigo";
	...
	public void onClick(View v) {
		...
		case R.id.search_button:
			...
			//tts.speak("Retrieving results", TextToSpeech.QUEUE_FLUSH, null);
